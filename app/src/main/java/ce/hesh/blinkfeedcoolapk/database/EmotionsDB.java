package ce.hesh.blinkfeedcoolapk.database;
...
import ce.hesh.blinkfeedcoolapk.bean.Emotion;
import ce.hesh.blinkfeedcoolapk.bean.Emotions;
    ...
    public static void checkEmotions() {
        ...
        try {
            ...
            if (cursor != null && cursor.moveToFirst()) {
                int count = cursor.getInt(0);
                Logger.v(TAG, "emotion count:"+count);
                if (count == 261)
...
//		key = converter.convert(key);
    ...
    public static Emotions getEmotions(String type) {
        ...
        Cursor cursor = emotionsDb.rawQuery(" SELECT * FROM " + EmotionTable.table + " WHERE " + EmotionTable.file + " " + query + " '" + type
                + "%' order by ce_hesh_blinkfeed_coolapk_file", null);
//		Cursor cursor = emotionsDb.rawQuery(" SELECT * FROM " + EmotionTable.table + " order by ce_hesh_blinkfeed_coolapk_id ", null);
    ...
    static class EmotionTable {
        ...
        static final String table = "ce_hesh_blinkfeed_coolapk_emotions";

        static final String id = "ce_hesh_blinkfeed_coolapk_id";

        static final String key = "ce_hesh_blinkfeed_coolapk_key";

        static final String file = "ce_hesh_blinkfeed_coolapk_file";

        static final String value = "ce_hesh_blinkfeed_coolapk_value";
